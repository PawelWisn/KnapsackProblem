...
An example of a non-evolutionary solution to the knapsack problem can be a greedy algorithm that selects the most valuable items until the total weight and size of the items do not exceed the maximum values.
